...
so that the tail becomes the new head and all pointers are correctly pointed. You need to return the new head of the reversed
list. The printing and verification is done by the driver code.
...
public static Node reverseDLL(Node  head)
{
    ...
    while(curr!=null)
    {
        ...
        //as now to move forward we need to move to the previous node
        curr=curr.prev;
    }
