...
class DiagonalTraversalBinaryTree
{
     public ArrayList<Integer> diagonal(Node root)
      {
           ...
           if(root==null)
            ...
            //queue to store left of the curr null, for diagonal traversal
            //we keep on moving to the right of curr node, till we reach null
